  ...
  return (
    <section className="py-[5px]">
      ...
      <div className="my-[2000px] flex flex-col justify-center items-center">
        ...
        <TAOS
          className="bg-purple-600/40 py-12 delay-[300ms] duration-[700ms] taos:translate-y-[200px] taos:opacity-0 [animation-iteration-count:infinite]"
          offset={500}
        >
          <h1 className="text-9xl">Test</h1>
        </TAOS>
        <TAOS className="bg-purple-600/40 py-12 delay-[300ms] duration-[700ms] taos:translate-y-[200px] taos:opacity-0">
          <h1 className="text-9xl">Test</h1>
        </TAOS>
      </div>
    </section>
